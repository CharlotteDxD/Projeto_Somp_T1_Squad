...
def render():
    ...
    _header(
        ...
        "Cruzamento do aviso com a telemetria do período",
    )
    ...
    with tab1:
        ...
        for _, row in df_fila.head(10).iterrows():
            ...
            cor_docs = "#63A87C" if len(docs) >= 2 else "#E04B45"
                ...
                <div style="display:flex;justify-content:space-between;
                    ...
                    <div style="flex:1;">
                        ...
                        <div style="font-size:0.78rem;color:#8FA39B;
                                    line-height:1.6;">
                            Causa: <strong style="color:#E4EDE9;">
                    ...
                    <div style="text-align:right;min-width:120px;">
                        ...
                        <div style="margin-top:8px;padding-top:8px;
                                    ...
                                    font-size:0.7rem;color:#8FA39B;">
                            Razao indeniz/apolice:<br>
                            <strong style="color:#E4EDE9;">
    ...
    with tab2:
        ...
        with col_b:
            ...
            cor_r = "#E04B45" if razao > 0.7 else "#DDA53C" if razao > 0.4 else "#63A87C"
            st.markdown(f"""
            <div style="background:#0E1614;border:1px solid {cor_r}33;
                        border-left:3px solid {cor_r};border-radius:8px;
                        padding:10px 14px;margin-bottom:6px;">
                <div style="display:flex;justify-content:space-between;
                            align-items:center;">
                    <span style="font-size:0.85rem;color:#E4EDE9;">
            ...
            cor_d = ("#E04B45" if dias < 60 else
                     "#DDA53C" if dias < 180 else "#63A87C")
            st.markdown(f"""
            <div style="background:#0E1614;border:1px solid {cor_d}33;
            ...
            cor_doc = "#63A87C" if docs_n == 3 else "#DDA53C" if docs_n >= 2 else "#E04B45"
            st.markdown(f"""
            <div style="background:#0E1614;border:1px solid {cor_doc}33;
    ...
    with tab3:
        ...
        if PLOTLY_OK:
            ...
            fig.update_layout(plot_bgcolor="#0E1614", paper_bgcolor="#0E1614",
                              font=dict(color="#E4EDE9"), height=400)
    ...
    with tab4:
        ...
        if PLOTLY_OK:
            ...
            with col_v1:
                ...
                fig1.update_layout(plot_bgcolor="#0E1614",
                                   paper_bgcolor="#0E1614",
            ...
            with col_v2:
                ...
                fig2 = px.pie(status_counts, names="Status", values="Quantidade",
                              ...
                              template="plotly_dark",
                              color_discrete_sequence=["#63A87C", "#DDA53C", "#E04B45"])
                fig2.update_layout(plot_bgcolor="#0E1614",
                                   paper_bgcolor="#0E1614",
                                   font=dict(color="#E4EDE9"), height=320)
    ...
    st.markdown("---")
    st.markdown(f"""
    <div style="background:rgba(221,165,60,0.04);
                border:1px solid rgba(221,165,60,0.2);
                border-left:3px solid #DDA53C;border-radius:10px;
                padding:12px 18px;font-size:0.78rem;color:#8FA39B;line-height:1.7;">
        <strong style="color:#E4EDE9;">Status de integracao US08:</strong><br>
        <span style="color:#63A87C;">x</span> Pagina criada e funcional ·
        <span style="color:#63A87C;">x</span> Z-Score sobre base SUSEP ·
        <span style="color:#63A87C;">x</span> Decisao auditada ·
        <span style="color:#63A87C;">x</span> Cluster de casos similares ·
        <span style="color:#DDA53C;">~</span> Aguardando base SUSEP real (Guilherme)
    </div>
    """, unsafe_allow_html=True)
